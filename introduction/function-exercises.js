 ...
 */
function numberCompare(num, num1) {
  if (num > num1) {
...
function isPalindrome(par) {
  par = par.toString();
  parCopy = par.split(" ").join("");
  parCopy = parCopy.split("");
  revPar = [];
  console.log(parCopy);
  for (let ite of parCopy) {
    revPar.unshift(ite);
  }
  revPar = revPar.join("");
  return revPar == par;
...
function RoPaSc(choice) {
  choice = choice.toLowerCase();
  let computerCh = Math.floor(Math.random() * 3);
  let tools = {
    0: "rock",
    1: "paper",
    2: "scissor",
  ...
  switch (choice) {
    case "rock":
      if ("paper" == tools[computerCh]) {
        console.log("you lose");
      } else if ("scissor" == tools[computerCh]) {
        console.log("you win");
      } else {
      ...
      break;
    case "paper":
      if ("scissor" == tools[computerCh]) {
        console.log("you lose");
      } else if ("rock" == tools[computerCh]) {
        console.log("you win");
      } else {
        console.log("keep playing");
      }
      break;
    case "scissor":
      if ("rock" == tools[computerCh]) {
        console.log("you lose");
      } else if ("paper" == tools[computerCh]) {
        console.log("you win");
      } else {
        console.log("keep playing");
      }
